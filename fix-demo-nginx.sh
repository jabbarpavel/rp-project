...
echo ""
echo "Next steps:"
echo "1. Test HTTP access: curl -I http://demo.kynso.ch"
echo "2. Set up SSL with: sudo certbot --nginx -d demo.kynso.ch"
echo "3. Test HTTPS access: curl -I https://demo.kynso.ch"
echo "4. Open in browser: https://demo.kynso.ch"
echo ""
